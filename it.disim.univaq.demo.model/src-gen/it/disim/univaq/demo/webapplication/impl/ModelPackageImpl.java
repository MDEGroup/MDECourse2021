...
import it.disim.univaq.demo.webapplication.Named;
...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	 ...
	 * @see it.disim.univaq.demo.webapplication.ModelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	 ...
	 */
	@Override
	public EReference getApplication_Enitities() {
	 ...
	 */
	@Override
	public EAttribute getProperty_IsPK() {
	...
	public void createPackageContents() {
		...
		createEReference(applicationEClass, APPLICATION__ENITITIES);
		...
		createEAttribute(propertyEClass, PROPERTY__IS_PK);
	...
	public void initializePackageContents() {
		...
		initEReference(getApplication_Enitities(), this.getEntity(), null, "enitities", null, 0, -1, Application.class,
		...
		initEClass(propertyEClass, Property.class, "Property", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEAttribute(getProperty_IsPK(), ecorePackage.getEBoolean(), "isPK", null, 0, 1, Property.class,
				!IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(referenceEClass, Reference.class, "Reference", !IS_ABSTRACT, !IS_INTERFACE,
				IS_GENERATED_INSTANCE_CLASS);
		initEReference(getReference_Ref(), this.getEntity(), null, "ref", null, 0, 1, Reference.class, !IS_TRANSIENT,
